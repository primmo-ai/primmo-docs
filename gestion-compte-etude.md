...
La **connexion Outlook** au niveau de l'étude permet, une fois validée, à chaque collaborateur de l'étude d'activer la synchronisation avec son compte Outlook.

Pour activer la connexion Outlook, vous devez effectuer la demande à votre gestionnaire de messagerie.&#x20;

Depuis le menu paramètres, cliquez sur "Lier mon compte outlook" puis sur "Première demande de votre étude?" et utilisez le message suggéré.
