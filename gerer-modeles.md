...
1. Dans la section **Modèles**, ouvrez le modèle à modifier (clic ou « Modifier »).
2. Modifiez le **nom** et/ou le **contenu**.
...
1. Dans la section **Modèles**, sélectionnez le modèle à supprimer.
2. Cliquez sur **Supprimer** (ou l’icône poubelle).
3. Confirmez la suppression si demandé.

Le modèle disparaît de la liste et ne sera plus proposé dans le chat. Cette action est en général définitive.
